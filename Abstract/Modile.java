...
public String setMob_name(String setMob_quality){
return this.Mob_quality;}

public String setMob_name(String setMob_company){
return this.Mob_comapany;}

public String setMob_size(float setMob_size){
return this.Mob_size;}
}
